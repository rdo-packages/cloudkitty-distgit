...
# uses modern SPDX license format which requires setuptools >= 70.0.0
%{__python3} -m pip install --user 'setuptools>=70.0.0'
...
* Tue May 1111111111111111111111 Foley <efoley@redhat.com>
- Add in wsgi script to replace the one removed upstream.
- Use pip to install setuptools >= 70.0.0 to support modern PEP 639 license
